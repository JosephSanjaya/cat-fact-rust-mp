...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_catfact_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_catfact_rustbuffer_free(self, $0) }
    }
}
...
public struct ApiConfig: Equatable, Hashable {
    public var baseUrl: String?
    public var csrfToken: String?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(baseUrl: String?, csrfToken: String?) {
...
public struct CatFactData: Equatable, Hashable {
    public var fact: String
    public var length: UInt64

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(fact: String, length: UInt64) {
        self.fact = fact
        self.length = length
    }
...
#if compiler(>=6)
extension CatFactData: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCatFactData: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CatFactData {
        return
            try CatFactData(
    ...
    public static func write(_ value: CatFactData, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCatFactData_lift(_ buf: RustBuffer) throws -> CatFactData {
    return try FfiConverterTypeCatFactData.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCatFactData_lower(_ value: CatFactData) -> RustBuffer {
    return FfiConverterTypeCatFactData.lower(value)
}
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_catfact_uniffi_contract_version()
...
public func uniffiEnsureCatfactInitialized() {
